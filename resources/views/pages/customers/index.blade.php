@extends('layout.app')
    ...
    <table class="rounded-t-lg m-5 w-5/6 mx-auto bg-white text-gray-800 shadow-md text-sm">
      <tr class="text-center border-b-2 border-gray-300">
        ...
        <th class="px-4 py-3">  <a href="{{route('customers-create')}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border-blue-700 rounded" >Dodaj Kontrahenta</a></th>
      </tr>
